...
const navigation: { name: string; href: string }[] = [
  { name: 'Instagram', href: 'https://www.instagram.com/erifullmoon' },
  { name: 'LinkedIn', href: 'https://gr.linkedin.com/in/eri-panselina' },
]
                ...
                >
                  <div className="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                    <div className="flex items-center justify-between w-full md:w-auto">
                      <Link href="/">
                        <a>
                          <span className="sr-only">Eri Panselina</span>
                          <span>Home</span>
                        </a>
                      </Link>
